> ## 🪧 Fork notice
>
> This repository is a **fork of [FabexCNC / BlenderCAM](https://github.com/vilemduha/blendercam)**
> (`vilemduha/blendercam`, upstream commit `ae5ab17`), vendored here as a foundation
> to build a VCarve-style CNC CAM toolset.
>
> **What was changed from upstream:**
> - Removed the bundled `fabex/wheels/` directory (~194 MB of redistributable
>   third-party wheels). Restore them with [`scripts/fetch_wheels.sh`](scripts/fetch_wheels.sh)
>   before building/installing the Blender extension.
> - Removed upstream CI configs (`.github/`, `.forgejo/`) so they don't run on this repo.
>
> All original code remains under its **GPLv3** license (see [`LICENSE`](LICENSE)).
> Original work © 2012–2024 Vilem Novak, Alain Pelletier & contributors.
>
> ---
